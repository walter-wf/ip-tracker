      ...
      <section>
        ...
        {address && (
          <>
            ...
            <MapContainer
              center={address.location?.lat && address.location?.lng ? [address.location.lat, address.location.lng] : [0, 0]}
              zoom={13}
            ...
            >
              ...
              />
              {address.location?.lat && address.location?.lng && <Markerposition address={address} />}
            </MapContainer>
